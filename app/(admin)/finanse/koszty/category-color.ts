...
const CATEGORY_COLORS: Record<string, string> = {
  ...
  "Odłożona gotówka - poduszka": "bg-yellow-100 text-yellow-800 dark:bg-yellow-950 dark:text-yellow-300",
  "Wartość inwestycji - akcje, obligacje": "bg-lime-100 text-lime-800 dark:bg-lime-950 dark:text-lime-300",
  "Wartość inwestycji - krypto": "bg-amber-100 text-amber-800 dark:bg-amber-950 dark:text-amber-300",
